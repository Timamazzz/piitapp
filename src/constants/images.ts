...
export const blurImage = require('../assets/images/blurImage.png');
export const backButton = require('../assets/images/backButton.png');
...
export const newsActiveIcon = require('../assets/images/TabIcons/newspaper.png');
export const userActiveIcon = require('../assets/images/TabIcons/user.png');
export const orderActiveIcon = require('../assets/images/TabIcons/order.png');
